        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="modal fade" id="modalLaporan" wire:ignore.self>
                    ...
                    <div class="modal fade" id="modalTransaksi" wire:ignore.self>
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('laporan.transaksi.all') }}" method="post">
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-outline-dark fw-bold">Cetak</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            {{ $transaksi->links('layouts.paginate-livewire') }}
                        </div>
                    </div>
                </div>
            </div>
